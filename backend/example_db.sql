...
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
 ...
 # João pedro das Neves Canaes
	
INSERT INTO exemploBasicInfo (exemploID, firstName,lastName,placeOfOrigin,tags,briefing,podcastLink,imageLink,insertionDate)
	VALUES ('joaocanaes','João pedro', 'das Neves Canaes', 'Santos - SP', 'Ciencias', 'João Pedro das Neves Canaes é um jovem santista que atualmente cursa Engenharia civil na Escola Politécnica da Universidade de São Paulo. Tendo estudado no Instituto Federal de São Paulo – Campus Cubatão, ele foi o primeiro aluno a participar de um programa de verão internacional: a Escola de Verão de Física na Universidade do Porto, em Portugal. Além disso, João também foi responsável por incentivar uma cultura de olimpíadas científicas dentro do seu colégio e motivar estudantes a buscar oportunidades internacionais.', 'https://castbox.fm/app/castbox/player/id2209666/id205522746?v=8.11.6&autoplay=0', 'https://exempl.io/images/JoaoCanaes.jpg','2019-11-27');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Infância', 'Já com sete anos de idade, João possuía um ávido interesse por matemática. Ele conta que um dos hobbies favoritos era passar o tempo somando muitos números em um papel sulfite. Além disso, João já demonstrava a sua disposição pela engenharia civil. Com nove anos, ele adorava observar pontes e prédios e imaginar como eles eram feitos.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Apagar para acompanhar?', 'Com oito anos de idade, João decidiu completar a sua apostila de Matemática. No entanto, a sua professora ordenou-lhe que apagasse, pois ele deveria acompanhar o ritmo da sala. João conta que tal acontecimento reforça a sua opinião que as escolas “com base [educacional]” geralmente falham em identificar e incentivar o potencial dos alunos.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Xadrez', 'Nessa mesma idade, João passou a se dedicar a campeonatos de xadrez do seu segundo até o último ano do ensino fundamental. Ele conta que o seu apreço pela matemática lhe ajudou a gostar desse hobby.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Técnico em edificações', 'Estando no primeiro ano do ensino médio, João decidiu voltar um ano e concorrer ao vestibular do Instituto Federal de São Paulo — Campus Cubatão e do técnico em edificações na ETEC. Para se preparar, ele destaca que era o tipo de aluno “chato”: aquele que não tinha medo de perguntar todas as dúvidas para o seu professor. Ao ser admitido em ambos, ele passou a cursá-los simultaneamente. ');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Ensino médio', 'Quando João ingressou no Instituto Federal, ele passou a ter sérias dificuldades com Física. Na metade do ano, estava prestes a repetir de ano: havia fechado com 4.5 de média. Assim, decidiu procurar todo tempo possível para se dedicar a matéria. Então, ele conseguiu elevar a sua média para 9.5. Para isso, João nos conta que foi necessário “entender como se estudava Física” e que cada “matéria tem seu jeito de ser estudada.”.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Olímpiadas científicas', 'No seu segundo ano, João ganhou uma medalha de ouro na Mostra Brasileira de Foguetes (MOBFOG). Mesmo não havendo uma cultura de Olímpiadas Científicas na sua escola, ele também conseguiu ser o único aluno a ser selecionado para a terceira fase da Olímpiada Brasileira de Física. ');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Escola de verão de Física', 'No seu terceiro ano, ele foi selecionado para a Escola de Verão de Física na Universidade de Coimbra em Portugal. Durante cinco dias, ele conduziu um projeto sobre supercondutores. Por não ter tido estudado eletromagnetismo na época, João passou madrugadas em claro correndo atrás do conhecimento. Com isso, João teve a ideia de demonstrar fisicamente que supercondutores poderiam levantar um container de 20 toneladas e ter aplicações práticas na indústria. Em um dia e meio, João e sua equipe completaram o trabalho e apresentaram-lhe em público.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Física Olímpica', 'No seu quarto ano, João fundou o projeto “Física Olímpica”, em que preparava alunos para as olímpiadas científicas. Devido ao seu jeito inovador como professor, ele conseguiu levar cinco outros alunos para a Final da Olímpiada Brasileira de Física — um ato inédito naquele ano.');
INSERT INTO exemploTimelineItem (exemploID_FKEY, eventTitle, eventDescription) 
	VALUES ('joaocanaes','Vestibular', 'Depois de formado no Instituto Federal, João decidiu tirar um ano para se dedicar à FUVEST. Assim, ingressou em um cursinho da região. Para ser admitido na POLI-USP, ele conta que três coisas foram fundamentais: ter focado apenas em treinar com questões da FUVEST, não faltar à nenhuma aula do cursinho e reduzir, mas não parar, os estudos nas férias de julho.');
